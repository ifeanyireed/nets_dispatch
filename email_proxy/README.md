...
```
Authorization: Bearer sk_live_6f3b92d8a4c1e7f50b4a1d9c2e8f7a3b
```
*or*
```
X-API-Key: sk_live_6f3b92d8a4c1e7f50b4a1d9c2e8f7a3b
```
...
func main() {
	...
	req.Header.Set("Authorization", "Bearer sk_live_6f3b92d8a4c1e7f50b4a1d9c2e8f7a3b")
