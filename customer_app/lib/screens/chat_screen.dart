...
class _ChatScreenState extends State<ChatScreen> {
  final List<Map<String, dynamic>> _messages = [
    {
      'sender': 'them',
      'text': 'Hi! I have picked up your package and I am on my way to the delivery location.',
      'time': '5m ago',
      'hasHeart': false,
    },
    {
      'sender': 'me',
      'text': 'Great! Please give me a call when you arrive at the gate.',
      'time': '2m ago',
      'isRead': true,
    },
  ];
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: AssetImage(widget.avatarImage ?? 'assets/moodboard/biker01.jpeg'),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
